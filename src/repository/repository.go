...
type Repository interface {
	...
	DeleteProduct(ctx echo.Context, ProdutId int) error
...
func DeleteProduct(ctx echo.Context, ProductId int) error {
	return implementation.DeleteProduct(ctx, ProductId)
}
